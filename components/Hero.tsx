  ...
  return (
    <section className="relative flex min-h-[100svh] items-center overflow-hidden">
      <Image
        ...
        priority
        sizes="100vw"
        className="object-cover object-[68%_center] [filter:saturate(0.8)_contrast(1.05)]"
      />
      <div className="absolute inset-0 bg-gradient-to-r from-ink/85 via-ink/50 to-ink/12" />
      <div className="absolute inset-0 bg-gradient-to-t from-ink/60 via-transparent to-ink/55" />
      ...
      <div className="relative mx-auto w-full max-w-6xl px-6 pt-28">
        <div className="max-w-2xl">
          <motion.p
            ...
            className="mb-6 font-sans text-xs uppercase tracking-[0.24em] text-champagne"
          >
            Co-Founder &amp; Chief Operating Officer &middot; Square Yards
          </motion.p>

          <h1 className="font-serif text-[3.5rem] font-medium leading-[1.02] text-parchment sm:text-7xl lg:text-[5.25rem]">
            {line("Kanika", 0.15)}
            {line("Gupta", 0.27)}
